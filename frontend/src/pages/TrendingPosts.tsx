...
//       try {
//         const response = await axios.get(`/api/v1/posts/trending`);
//         const allPosts: Post[] = response.data.trendingPosts;
//         // Sort posts by reaction count in descending order
//         const sortedPosts = allPosts.sort((a, b) => b.reactions.length - a.reactions.length);
//         // Get the top 6 posts
//         const topPosts = sortedPosts.slice(0, 6);
...
//   return (
//     <div 
//       className="min-h-screen flex items-center justify-center text-[#000435] bg-white dark:text-white dark:bg-[#000435]" 
...
//               currentUser={null} 
//               onDelete={() => {
//                 // Handle delete function if necessary
//               }} 
//             />
//           ))}
//         </div>
