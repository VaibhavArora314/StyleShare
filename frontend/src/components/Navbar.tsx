...
const Navbar = () => {
  ...
  const getNavLinkClass = (path: string) => {
    return location.pathname === path
      ? "block py-2 px-3 bg-blue-600 rounded md:bg-transparent md:p-0 text-white md:text-blue-800"
      : "block py-2 px-3 rounded md:border-0 md:p-0 text-white md:hover:text-blue-900 hover:bg-blue-400 hover:text-white md:hover:bg-transparent";
  };
  ...
  return (
    <nav className="bg-gradient-to-r from-blue-900 via-sky-300 to-blue-900  fixed w-full z-20 top-0 start-0 ">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <img src={logo} className="h-12" alt="Styleshare Logo" />
          <span className="self-center justify-between text-3xl font-bold whitespace-nowrap text-white font-mono">
          {t("navbar.logo")}
          </span>
        </Link>
       <button
