            ...
            <div className='md:w-3/4 md:flex'>
                ...
                <p className='text-gray-200 font-bold'>Legal Pages</p>
                    <ul className='text-gray-300 py-4 cursor-pointer'>
                        <li className='py-1 cursor-pointer'>
                        <li className='py-1 cursor-pointer'>
    <Link to='/app/policy#privacy-policy'>Privacy Policy</Link> 
</li>
<li className='py-1 cursor-pointer'>
    <Link to='/app/policy#terms-and-conditions'>Terms and Conditions</Link> 
</li>
<li className='py-1 cursor-pointer'>
    <Link to='/app/policy#cookie-policy'>Cookie Policy</Link> 
</li>
