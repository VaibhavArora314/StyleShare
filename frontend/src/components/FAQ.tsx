      ...
      >
        ...
        <dl className="flex flex-col items-center">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="w-[83%] mb-2 transition-transform duration-300 hover:translate-y-1"
            >
              <div
                className={`rounded-lg border-2 border-transparent transition-all duration-300 ${
                  activeIndex === index ? "border-[#000435]" : ""
                }`}
              >
                <button
