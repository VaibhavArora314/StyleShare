...
//         <h2 className="text-3xl md:text-4xl mb-14 font-extrabold text-center text-[#000435] bg-white dark:text-white dark:bg-[#000435]">{t("editor.title")}</h2>
...
const Showcase: React.FC = () => {
  ...
  return (
    <section className="text-[#000435] bg-white dark:text-white dark:bg-[#000435]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl md:text-4xl mb-14 font-extrabold text-center text-[#000435] bg-white dark:text-white dark:bg-[#000435]">
          {t("editor.title")}
        </h2>
        <div className="flex flex-col md:flex-row md:space-x-6 items-center">
          <div className="md:w-1/2 space-y-5">
            {features.map((feature, index) => (
              <div key={index} className="p-6 rounded-lg shadow-md border-2 animated-border1 transition-transform duration-300 hover:-translate-y-1">
                <h3 className="text-2xl font-bold mb-2">{t(`editor.${feature.key}.title`)}</h3>
                <p className="text-lg font-mono">{t(`editor.${feature.key}.description`)}</p>
              </div>
            ))}
          </div>
          <div className="mt-10 md:mt-0 md:w-1/2 flex justify-center">
